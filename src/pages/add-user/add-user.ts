...
export class AddUserPage {
  ...
  addUser() {
    if(this.formAddUser.valid && this.myphoto!=this.defaultPhotoPath){
      ...
      postData['type']=this.filterType;

      this.http.post(this.global.serverAddress+"api/add_user.php", JSON.stringify(postData))
        .subscribe(data => {
          ...
          if(response.response=="success"){
            ...
            let alert = this.alertCtrl.create({
              title: 'Add User',
              subTitle: this.filterType+' Account successfully created!',
              buttons: ['OK']
            });
            alert.present();
            this.returnHome();
            ...
            let alert = this.alertCtrl.create({
                title: 'Add User',
                subTitle: this.filterType+' Account could not be added!',
                buttons: ['OK']
            });
            alert.present();
         }
